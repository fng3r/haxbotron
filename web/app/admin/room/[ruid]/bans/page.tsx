...
import { NewBanEntry, mutations, queries } from '@/lib/queries/player';
...
export default function RoomBanList() {
  ...
  const addPlayerBanMutation = mutations.addPlayerBan();
  const removePlayerBanMutation = mutations.removePlayerBan();
