...
import type { RuntimeRoomRpcRequest } from "../../../lib/room/RoomProtocol.js";
...
let roomWorkerModule: typeof import("../../../game/runtime/roomWorker.js");
...
function createRuntimeCommand<C extends Exclude<keyof import("../../../lib/room/RoomProtocol.js").RoomRpcContract, "openRoom">>(
    command: C,
...
describe("roomWorker pipeline", () => {
    beforeEach(async () => {
        ...
        jest.unstable_mockModule("../../../game/runtime/RoomBootstrap.js", () => ({
            openRoomRuntime: mockOpenRoomRuntime,
        }));
        jest.unstable_mockModule("../../../game/runtime/RoomCommandHandler.js", () => ({
        ...
        roomWorkerModule = await import("../../../game/runtime/roomWorker.js");
